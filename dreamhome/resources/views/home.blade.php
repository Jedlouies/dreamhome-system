...
<div x-data="{
    ...
    <div x-show="open" x-cloak
        ...
        <form action="{{ route('viewings.book') }}" method="POST">
            @csrf
            ...
            <div x-show="step === 1" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea rows="3" name="comment" placeholder="e.g. Currently renting, looking to move by August..." class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#853953]/30 focus:border-[#853953] transition-all resize-none"></textarea>
                </div>
                <div class="flex gap-3 pt-1">
                    <button type="button" @click="open = false" class="flex-1 py-3 bg-gray-100 text-gray-500 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-gray-200 transition-all">Cancel</button>
            ...
            <div x-show="step === 2" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="date" name="view_date" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#853953]/30 focus:border-[#853953] transition-all">
                </div>
                <div class="flex gap-3 pt-1">
                ...
                <div class="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl border border-gray-100 hover:border-pink-100 transition-all duration-300">
                    <div class="flex flex-col lg:flex-row">
                        <div class="relative lg:w-1/2 aspect-[4/3] overflow-hidden">
                            @if(isset($featured->main_image) && $featured->main_image)
