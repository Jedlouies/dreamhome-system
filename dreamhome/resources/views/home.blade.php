...
<div x-data="{
    ...
    openModal(name, id, type) {
        ...
        this.propertyType = type; this.step = 1; this.open = true;
    }
}">
    ...
    <div x-show="open" x-cloak
         ...
         @click="open = false" class="fixed inset-0 bg-black/40 backdrop-blur-sm z-40"></div>
        ...
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden" @click.stop>
            ...
            <div x-show="step === 1" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="tel" placeholder="e.g. 0912-345-6789" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#853953]/30 focus:border-[#853953] transition-all">
                </div>
                <div>
                    ...
                    <textarea rows="3" placeholder="e.g. Currently renting, looking to move by August..." class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#853953]/30 focus:border-[#853953] transition-all resize-none"></textarea>
                </div>
                <div class="flex gap-3 pt-1">
                    <button @click="open = false" class="flex-1 py-3 bg-gray-100 text-gray-500 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-gray-200 transition-all">Cancel</button>
                    <button @click="step = 2" class="flex-1 py-3 bg-[#853953] text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-[#6e2e44] active:scale-95 transition-all flex items-center justify-center gap-2">
            ...
            <div x-show="step === 2" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="number" placeholder="e.g. 20000" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#853953]/30 focus:border-[#853953] transition-all">
                </div>
                <div>
                    <label class="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1.5">Preferred Viewing Date</label>
                    <input type="date" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#853953]/30 focus:border-[#853953] transition-all">
                </div>
                <div class="flex gap-3 pt-1">
                    <button @click="step = 1" class="flex-1 py-3 bg-gray-100 text-gray-500 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-gray-200 transition-all flex items-center justify-center gap-2">
                    ...
                    <button class="flex-1 py-3 bg-[#853953] text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-[#6e2e44] active:scale-95 transition-all">Confirm Viewing</button>
                </div>
            </div>
                ...
                <div class="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl border border-gray-100 hover:border-pink-100 transition-all duration-300">
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="lg:w-1/2 p-8 flex flex-col justify-between">
                            ...
                            <button
                                @click="openModal('{{ $featured->street }}', '{{ $featured->propertyno }}', '{{ $featured->property_type }}')"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 hover:border-pink-100">
                    ...
                    <div class="p-5">
                        ...
                        <button
                            @click="openModal('{{ $property->street }}', '{{ $property->propertyno }}', '{{ $property->property_type }}')"
