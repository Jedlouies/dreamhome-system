            ...
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
                ...
                <div class="flex items-center space-x-4 w-full md:w-auto">
                    <div class="relative w-full md:w-64">
                        ...
                        <input type="text" placeholder="Search properties..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#853953] focus:border-[#853953] block w-full pl-10 p-2.5">
                    </div>
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 font-medium text-[#853953]">P001</td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="text-gray-900 font-semibold">123 Green Lane</span>
                                    <span class="text-xs text-gray-400">Kauswagan, CDO</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-900">₱15,000</td>
                            <td class="px-6 py-4 text-xs">S001 (Jed Camara)</td>
