            ...
            <div class="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div onclick="window.location='{{ route('staff.reports.generate', ['type' => $report['slug']]) }}'" 
                             class="bg-white rounded-[2.5rem] p-8 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-pointer border border-transparent hover:border-pink-50 relative overflow-hidden">
