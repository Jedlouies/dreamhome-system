                    ...
                    <div>
                        <div class="flex items-center justify-between mb-6 px-2">
                            <div class="flex items-center gap-2 flex-1">
                                <h2 class="text-[10px] font-black uppercase tracking-[0.2em] text-[#853953]">Active Portfolio</h2>
                            ...
                            <div class="space-y-4">
                                @forelse($assignedInspections as $ins)
                                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col gap-4">
                                        ...
                                        <form action="{{ route('staff.inspections.complete', $ins->inspectionid) }}" method="POST" class="space-y-3 pt-2 border-t border-slate-50">
                                            @csrf
                                            @method('PATCH')
